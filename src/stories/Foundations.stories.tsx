...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Complete foundation showcase including colors, typography, spacing, and accessibility features of the Beacon Design System.",
      },
    },
  },
  tags: ["autodocs"],
        ...
        <div className="grid grid-cols-10 gap-2">
          {[
            ...
            <div key={shade} className="text-center">
              ...
              />
              <span className="text-caption font-sans text-neutral-600">
                {shade}
              </span>
            </div>
          ))}
...
export const Typography: Story = {
  render: () => (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-display text-neutral-900 font-sans">
          Display Text
        </h1>
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          64px, Bold, -0.03em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          48px, Semibold, -0.03em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          40px, Semibold, -0.03em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          32px, Semibold, -0.02em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          28px, Semibold, -0.02em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          24px, Semibold, -0.02em letter spacing
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          20px, Semibold, -0.01em letter spacing
        </p>
      </div>

      <div>
        <p className="text-body-lg text-neutral-900 font-sans">
          Body Large Text
        </p>
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          18px, Normal weight, 1.6 line height
        </p>
      </div>

      <div>
        <p className="text-body text-neutral-900 font-sans">
          Body Text - This is the default body text size used throughout the
          design system. It provides excellent readability while maintaining
          efficient use of space.
        </p>
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          16px, Normal weight, 1.6 line height
        </p>
      </div>

      <div>
        <p className="text-body-sm text-neutral-900 font-sans">
          Body Small Text
        </p>
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          14px, Normal weight, 1.4 line height
        </p>
      </div>
      ...
      <div>
        ...
        <p className="text-body-sm font-sans text-neutral-600 mt-1">
          12px, Normal weight, 1.4 line height
        </p>
      </div>
    </div>
  ),
...
export const Spacing: Story = {
  render: () => (
    <div className="space-y-6">
      <h2 className="text-heading-3 text-neutral-900 font-sans">
        4px Grid System
      </h2>
      <div className="space-y-4">
        {[
          ...
          <div key={name} className="flex items-center gap-4">
            ...
            <span className="text-body font-sans text-neutral-900 w-20">
              {value}
            </span>
            <span className="text-body-sm font-sans text-neutral-600">
              {name}
            </span>
          </div>
        ))}
    ...
    <div className="space-y-8 max-w-4xl">
      <div>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-4">
            <h3 className="text-heading-5 text-neutral-900 font-sans">
              High Contrast (7:1+)
            </h3>
            <div className="space-y-2">
              <div className="p-4 bg-white border border-neutral-200 rounded">
                <p className="text-body font-sans text-primary-600">
                  Primary text on white background
                </p>
              </div>
              <div className="p-4 bg-primary-600 rounded">
                <p className="text-body font-sans text-white">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="p-4 bg-white border border-neutral-200 rounded">
                <p className="text-body font-sans text-neutral-600">
      ...
      <div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            />
            <span className="text-body font-sans" style={{ color: "#166534" }}>
              Success: Never relies on color alone
            </span>
          </div>
          <div
            className="flex items-center gap-3 p-3 rounded"
          ...
          >
            ...
            />
            <span className="text-body font-sans" style={{ color: "#991b1b" }}>
              Error: Always includes visual indicators
            </span>
          </div>
          <div
            className="flex items-center gap-3 p-3 rounded"
          ...
          >
            ...
            />
            <span className="text-body font-sans" style={{ color: "#92400e" }}>
              Warning: Multiple visual cues provided
            </span>
          </div>
          <div
            className="flex items-center gap-3 p-3 rounded"
          ...
          >
            ...
            />
            <span className="text-body font-sans" style={{ color: "#075985" }}>
              Info: Accessible to all users
            </span>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="space-y-3">
          <button
            className="px-4 py-2 text-body font-sans text-white rounded focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all"
